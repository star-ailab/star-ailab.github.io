...
<div markdown="0" class="wrapper" style="border-bottom: 1px solid $black <!--$grey-color-->; border:4px; height:300px; overflow:auto;">
	<ul class="awards" style="margin-bottom: -5px">
		<li>We have been awarded the NSF CyberAI Innovation Grant, 2026-2029. Thanks to NSF! </li>
		<br>
...
### Founder's Bio, [Curriculum vitae](/files/Ebrahimi_CV_2026.pdf), and [Google Scholar](https://scholar.google.com/citations?user=fFfNnJA7n38C&hl=en&oi=ao) 
