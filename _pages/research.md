...
**Privacy-Preserving Federated Machine Learning with Efficient Secure Aggregation**  ![]({{ site.url }}{{ site.baseurl }}/images/respic/eseafl.png){: style="width: 40%; float: right; margin: 0px 10px"}
