...
**Learning Contextualized Action Representations for Adversarial Malware Optimization** ![]({{ site.url }}{{ site.baseurl }}/images/respic/accar.png){: style="width: 40%; float: right; margin: 0px 10px"}
...
The paper is forthcoming in 2025, but you can get an early version from [here] (https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10711271).
