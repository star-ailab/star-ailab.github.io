...
**WARDEN: Information Theoretic Adversarial Training of Large Language Models** ![]({{ site.url }}{{ site.baseurl }}/images/respic/warden.png){: style="width: 38%; float: right; margin: 0px 10px"}
...
You can access the paper [here](https://arxiv.org/pdf/2605.05415).
...
You can access the MISQ paper [here](/files/radar.pdf).

**rsVAC: Risk-Sensitive Variational Actor-Critic** ![]({{ site.url }}{{ site.baseurl }}/images/respic/rsvac.png){: style="width: 36%; float: right; margin: 0px 10px"}
...
You can access the ICLR paper [here](/files/rsvac.pdf).

**AC-CAR: Learning Contextualized Action Representations in Sequential Decision Making for Adversarial Malware Optimization** ![]({{ site.url }}{{ site.baseurl }}/images/respic/accar.png){: style="width: 36%; float: right; margin: 0px 10px"}
...
You can access the TDSC paper [here](/files/Learning_Contextualized_Action_Representations_in_Sequential_Decision_Making_for_Adversarial_Malware_Optimization.pdf).
...
You can see the SIAM paper [here](/files/armor.pdf). You can also see our ARMOR method at a glance [here](/files/Birrell_ICERM_2024_Poster-1.pdf).
...
You can see the NeurIPS paper [here](/files/fsrdp.pdf). You can also see our FSRDP method at a glance [here](/files/DPSGD_Poster.pdf).
...
**e-SeaFL: Privacy-Preserving Federated Machine Learning with Efficient Secure Aggregation**  ![]({{ site.url }}{{ site.baseurl }}/images/respic/eseafl.png){: style="width: 30%; float: right; margin: 0px 10px"}
...
You can see the paper [here](/files/eseafl.pdf).
...
**EW-Tune: Private Fine-Tuninig of Large Language Models**  ![]({{ site.url }}{{ site.baseurl }}/images/respic/ew.png){: style="width: 30%; float: right; margin: 0px 10px"}
...
**ADREL: Multilingual Cyber Threat Detection in the Russian Dark Web with Adversarial Deep Representation Learning** ![]({{ site.url }}{{ site.baseurl }}/images/respic/rus_en.png){: style="width: 45%; float: right; margin: 0px 10px"}
...
**HANDA: Multilingual Cyber Threat Detection in Russian and French Darknet Market Places with Adversarial Kernel Matching** ![]({{ site.url }}{{ site.baseurl }}/images/respic/rus_fr.png){: style="width: 45%; float: right; margin: 0px 10px"}
